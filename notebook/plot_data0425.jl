...
function render_data(file_name)
	# read from HDF5 file:
	data_path = datadep"SqState/data/data0425"
	...
	# write w into h5
	h5open(joinpath(data_path, "WignerSurface0425.h5"), "cw") do file
...
render_data("SQ1output0425.h5") |> DisplayAs.PNG
...
render_data("SQ2output0425.h5") |> DisplayAs.PNG
...
render_data("SQ3output0425.h5") |> DisplayAs.PNG
...
render_data("SQ4output0425.h5") |> DisplayAs.PNG
